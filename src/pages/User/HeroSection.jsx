...
const HeroSection = () => {
  return (
    <>
      <section className=" bg-blue-50 relative overflow-hidden h-screen w-full">
        <div className="flex relative z-20 items-center overflow-hidden w-full">
          <div className="container mx-auto px-6 flex relative py-16 ">
            ...
            <div className="hidden xl:block sm:w-1/3 xl:w-3/5 relative">
              <img
                src="/assets/Monitoringthecreativesdataperforming-ezgif.com-gif-maker.gif"
                className="w-full h-5/6  m-auto rounded-full"
              />
            </div>
          </div>
        </div>
