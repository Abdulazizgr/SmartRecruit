...
const JobDetailsPage = () => {
  ...
  const responsibilities = Array.isArray(job.responsibilities) ? job.responsibilities : job.responsibilities.split('\n');
  const requirements = Array.isArray(job.requirements) ? job.requirements : job.requirements.split('\n');
  const preferredSkills = Array.isArray(job.preferredSkills) ? job.preferredSkills : job.preferredSkills.split('\n');
